  ...
  return (
    <Container>
      ...
      {requestFriendsOfCurrentUser.length > 0 ? (
          ...
          <div key={user._id} className="container-friend-request">
            ...
            <div className="user-nav">
              <button
                ...
                onClick={() =>
                  dispacth(
                    acceptFriendRequest(user, currentUser, toast, socket)
                  )
                }
              >
              ...
              <button
                ...
                onClick={() =>
                  dispacth(
                    declineFriendRequest(user, currentUser, toast, socket)
                  )
                }
              >
                {<BsFillBookmarkXFill />}
        ...
        <h3>you have no friends requests</h3>
      )}
    </Container>
  );
};
